...
function maskPhoneNumber(numberOrJid) {
  ...
  if (digits.length < 7) {
    // Terlalu pendek untuk disensor dengan aman, tampilkan generik
 ...
 * @param {Object} data
 * @param {string} data.nama - Nama customer (DIABAIKAN untuk field CUSTOMER, lihat data.customerNumber)
...
function generateTestimonyImage(data) {
  ...
  // CUSTOMER field SELALU nomor yang disensor, bukan nama kontak/pushname.
